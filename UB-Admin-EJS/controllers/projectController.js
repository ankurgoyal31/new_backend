...
//   const newImages = req.files[field].map(f => f.location);
//   updateData[field] = [ ...oldImages, ...newImages];
// }
// } 
...
//       project[field][index] = file.location;
//     }
//   });
...
// exports.patch("/edit-video", upload.single("video"), async (req, res) => {
//   try {

//   const videoUrl = `http://127.0.0.1:5000/uploads/videos/${req.file.filename}`;
//     const collection = await connectToDatabase();

//     await collection.findByIdAndUpdate(req.params.id, { video: videoUrl });
//     // await collection.insertOne({
//     //   title: req.body.title,
//     //   video: videoUrl
//     // });
